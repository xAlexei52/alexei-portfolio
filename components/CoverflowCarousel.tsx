...
const classes = (...values: (string | false | undefined)[]) =>
...
export function CoverflowCarousel({
  ...
  return (
    <div
      className={classes("coverflow", className)}
    ...
    >
      <div className="coverflow__stage">
        ...
        >
          <div className="coverflow__track" style={{ height: "var(--cf-card)" }}>
            {slides.map((slide, index) => (
              <div
                ...
                className={classes("coverflow__card", cardClassName)}
              >
      ...
      {showCaption && active?.title && (
        <div key={selected} className="coverflow__caption" aria-live="polite">
          <p className="coverflow__title">{active.title}</p>

          {active.subtitle && (
            <p className="coverflow__subtitle">{active.subtitle}</p>
          )}

          {active.tags && active.tags.length > 0 && (
            <ul className="coverflow__tags">
              {active.tags.map((tag) => (
          ...
          {active.meta && active.meta.length > 0 && (
            <dl className="coverflow__meta">
              {active.meta.map((row) => (
                <div className="coverflow__meta-row" key={row.label}>
                  <dt>{row.label}</dt>
                  <dd>{row.value}</dd>
                </div>
              ))}
